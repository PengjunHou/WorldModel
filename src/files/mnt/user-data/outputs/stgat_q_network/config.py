...
class Config:
    ...
    STGAT_NUM_SPATIAL_LAYERS = 2
    STGAT_NUM_TEMPORAL_LAYERS = 2
    STGAT_NUM_HEADS = 4
    STGAT_DROPOUT = 0.1
    ...
    LOG_DIR = './logs'
    RESULT_DIR = './results'
    VAE_CHECKPOINT_PATH = './checkpoints/perception_vae.pth'
