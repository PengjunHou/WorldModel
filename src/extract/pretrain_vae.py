...
class PerceptionMapDataset(Dataset):
    def __init__(self, env_config, model_config: Config, num_samples=10000):
...
def train_vae(env_config, model_config: Config ):
    ...
    # 数据集
    dataset = PerceptionMapDataset(env_config, model_config, num_samples=100)
...
def load_trained_vae(env_config, checkpoint_path, device="cuda"):
    # 从环境获取 map 尺寸
...
if __name__ == '__main__':
    ...
    dataset = PerceptionMapDataset(env_config, model_config, num_samples=20)
