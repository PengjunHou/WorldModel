...
class Config:
    ...
    VAE_PRETRAIN_BATCH_SIZE = 16
    VAE_PRETRAIN_LR = 0.0001
    VAE_PRETRAIN_DATA_DIR = '/home/peh324/Codes/WorldModel/src/extract/data'
    ...
    VAE_N_CHECKPOINT_DIR = '/home/peh324/Codes/WorldModel/src/extract/checkpoints_interestedmap'
    VAE_N_CHECKPOINT_PATH = '/home/peh324/Codes/WorldModel/src/extract/checkpoints_interestedmap/perception_N_vae.pth'
