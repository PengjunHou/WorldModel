...
from .ImageToBEV import ImageToBEVProjectorWithGlobal
from .MultiDet import MultiAgentBEVFusion
...
def fuse_multi_vehicle_bev(vehicles_data: List[Dict],
    ...
    save_path = f"result/det/multi_agent_bev_fusion_{time_step:03d}.png"
    # =============== 4. 可视化 ===============
    if visualize:
