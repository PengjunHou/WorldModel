...
class Comm_Comp_Base():
    def __init__(self, configs):
        ...
        self.Bandwidth = 25 # configs.Bandwidth
        self.Up_ratio = 0.6
        self.Down_ratio = 0.3
        self.guard_ratio = 0.1
        self.protocol_effi = 0.6
        # data size unit MB
        self.data_size_summary = 0.005
        self.data_size_map = 8
        # process time unit s 
        self.proc_time_per_map = 0.01
        self.spectral_efficiency = 3
        self.Frame_T = 0.2
        self.veh_cnt = 5
    ...
    def get_time_up1(self, map_size, area_count):
        ...
        """
        up_link_rate = self.get_uplink_rate()
        t = self.veh_cnt * (self.data_size_map / map_size) * area_count / up_link_rate
        return t
